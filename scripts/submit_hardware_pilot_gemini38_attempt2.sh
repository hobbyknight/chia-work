...
LOCATION="global"
OUT="/home/devstar7706/chia-work/results/hardware-pilot-gemini-3.8-flash-attempt-2.jsonl"
WARM="/home/devstar7706/chia-work/results/hardware-pilot-gemini-3.8-flash-attempt-2-warmup.jsonl"
...
echo "=== SUBMIT HARDWARE PILOT ATTEMPT 2 WITH GEMINI 3.8 FLASH ==="
  ...
  --runtime-env-json="$(cat <<JSON
{
  "env_vars": {
    ...
    "GEMINI_API_RETRY_BASE_SECONDS": "5",
    "GEMINI_API_RETRY_MAX_DELAY_SECONDS": "20"
  }
}
JSON
)" \
...
echo "Submitted Gemini 3.8 Flash hardware pilot attempt 2."
echo "output=$OUT"
